...
const Home: NextPage = () => {
  return (
    ...
    <div className="dark bg-slate-400 xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      ...
      <h1 className="text-[200px] text-[#d2d3d2] bg-[url('/vercel.svg')] bg-cover">Hello</h1>
      ...
      <div className="bg-white dark:bg-black flex flex-col justify-between 
      ...
      p-6 rounded-3xl shadow-xl">
        ...
        <div>
          <div className="flex justify-between my-2 ">
            <span className="font-semibold text-gray-500 dark:text-gray-100 ">Grey Chair</span>
            <span>$19</span>
          </div>
          <div className="flex justify-between my-2 ">
            <span className="font-semibold text-gray-500 dark:text-gray-100 ">Grey Chair</span>
      ...
      <div className="bg-white p-6 rounded-3xl shadow-2xl lg:col-span-2 xl:col-span-1">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="bg-blue-500 text-white py-2 px-10 rounded-lg text-xs">Add to Cart</button>
        </div>
