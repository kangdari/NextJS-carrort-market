...
const ItemDetail: NextPage = () => {
  return (
    <div className='px-4 py-10'>
      <div className='w-12 aspect-square bg-orange-400'></div>
      ...
      <div className='mb-8'>
        ...
        <div className='mt-5'>
          ...
          <div className='flex items-center justify-between space-x-2'>
            <button className='flex-1 bg-orange-400 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 shadow-md font-medium hover:bg-orange-600'>
              Talk to seller
            </button>
