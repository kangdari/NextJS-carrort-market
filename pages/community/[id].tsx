  ...
  return (
    <div>
      ...
      <div className='px-4'>
        ...
        />
        <button className='w-full mt-2 text-white bg-orange-500 hover:bg-orange-600 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none '>
          Upload product
        </button>
      </div>
    </div>
